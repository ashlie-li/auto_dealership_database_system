...
def add_customer(Act,Vin):
    ...
    if request.method == 'POST' and 'Phone' in request.form:
        ...
        if res2 == 'query is executed':
            ...
            return render_template('search_add_customer.html', msg2=res2, Vin=Vin, Act=Act, odometer=odometer,role=role) ###################
        ...
        if 'TaxNum' in request.form:
            ...
            if res3 == 'query is executed':
                ...
                return render_template('search_add_customer.html', msg2=res2, msg3='Business infomation '+res3, Vin=Vin, Act=Act, odometer=odometer,role=role) ##########
            ...
            if res3 == 'query is executed':
                ...
                runSQL.writeSQL("DELETE FROM Customers WHERE CustomerID = '{a}';".format(a=newCID))
                return render_template('search_add_customer.html', msg2=res2, msg3='Person infomation '+res3, Vin=Vin, Act=Act, odometer=odometer,role=role) ##########
