...
def add_vehicle():
    ...
    if request.method == 'POST' and 'Vin' in request.form and 'Manu' in request.form\
        ...
        if int(ModelYear) > int(cur_year)+1:
            msg2 = 'Invalid Information'
            return render_template('add_vehicle.html', msg2 = msg2, dropColor = dropColor, dropManu=dropManu, dropType=dropType, role=role)
        ...
        if res != 'query is executed' or res2 !='query is executed' :
            return render_template('add_vehicle.html', msg = 'Got an error: ' +res\
        ...
        if res3 != 'query is executed' or res2 !='query is executed':
            ...
            return render_template('add_vehicle.html', msg = 'Got an error: ' +res3\
                                   , dropColor = dropColor, dropManu=dropManu, dropType=dropType, role=role)
        else:
