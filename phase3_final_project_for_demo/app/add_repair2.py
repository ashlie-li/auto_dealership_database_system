            ...
            if res_check_open == 0: ##### if no open repair
                ...
                if len(res_check_same_day) >0:
                    ...
                    return render_template( 'error_handle.html', \
                                           msg=msg, to_url = '/add_repair/search_vehicle2') # Repair has been created in the same day, raise error message
    ...
    if request.method == 'POST' and 'CustomerID' in request.form:
        ...
        if 'odometer' in request.form:
            ...
            if res_create_repair == 'query is executed':
                ...
                return render_template( 'error_handle.html', msg='Invalid information or a Repair has been created today. Please retry!', to_url = '/add_repair/search_vehicle2')
...
def add_repair_update_repair2(Vin, CustomerID):
    ...
    if request.method == 'POST' and 'UpdateVin' in request.form:
        ...
        if request.method == 'POST' and  "close" in request.form:
            ...
            if int(res_check_close[0][0]) == 1:
                return render_template( 'error_handle.html', msg='The repair has been closed previously!', to_url = '/add_repair/search_vehicle2')
    ...
    return render_template('repair2.html', Vin=Vin, msg=msg, res1=res1, col=col, CustomerID=CustomerID, show='yes', role=role,customerName=customerName)
