...
CASE WHEN R.FirstRepairDate < S.FirstSalesDate THEN R.FirstRepairDate ELSE S.FirstSalesDate END 
AS FirstDate, CASE WHEN R.LastRepairDate >  S.LastSalesDate THEN R.LastRepairDate ELSE S.LastSalesDate END AS LastDate, 
IFNULL(S.SalesNumber,0) AS SalesNumber, IFNULL(R.RepairNumber,0) AS RepairNumber,
