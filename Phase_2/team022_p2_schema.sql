...
PhoneNum varchar(13)  varchar NOT NULL,
...
ALTER TABLE Vehicles
	ADD CONSTRAINT fk_vehicles_manufactrurer FOREIGN KEY (Manufacturer) Manufacturers (ManufacturerName),
	ADD CONSTRAINT fk_vehicles_clerk FOREIGN KEY (ClerkUsername) InventoryClerk (Username);
...
ALTER TABLE Cars
ADD CONSTRAINT fk_ cars_vehicles FOREIGN KEY (Vin) REFERENCES Vehicles(Vin);


ALTER TABLE Trucks
ADD CONSTRAINT fk_ trucks_vehicles FOREIGN KEY (Vin) REFERENCES Vehicles(Vin);


ALTER TABLE Convertibles
ADD CONSTRAINT fk_ convertibles_vehicles FOREIGN KEY (Vin) REFERENCES Vehicles(Vin);


ALTER TABLE VanMiniVans
ADD CONSTRAINT fk_ vanminivans_vehicles FOREIGN KEY (Vin) REFERENCES Vehicles(Vin);


ALTER TABLE SUVs
ADD CONSTRAINT fk_ suvs_vehicles FOREIGN KEY (Vin) REFERENCES Vehicles(Vin);
...
ALTER TABLE SalesEvents
	...
	ADD CONSTRAINT fk_sales_customers FOEREIGN KEY (CustomerID) REFERENCES Customers (CustomerID);
